      ...
      <div className="w-[600px] mt-20 max-w-full mx-auto border-gray4 border rounded-3xl px-5 sm:px-10 py-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <Link
            ...
            className="text-xs sm:text-sm text-primary font-semibold inline-block underline"
          >
            Forget password?
          </Link>
          ...
          <div>
            ...
            <button
              disabled={loading}
              className="w-full py-4 sm:py-5 rounded-lg text-sm sm:text-base bg-primary font-bold text-center text-white mt-6"
            >
